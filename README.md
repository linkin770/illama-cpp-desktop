...
####  Bug 修复
- 修复深色模式下中止按钮位置与发送按钮不一致的问题

### v0.0.20260514 (2026-05-14)
...
#### 🚀 新功能
- **.doc 文件支持**，使用 word-extractor 解析旧版 Word 二进制格式
